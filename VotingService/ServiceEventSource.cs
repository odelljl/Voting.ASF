...
{
    [EventSource(Name = "MyCompany-Voting.ASF-VotingService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestFailedEventId, Level = EventLevel.Error, Message = "Service request '{0}' failed. ActivityId: {1}.", Keywords = Keywords.Requests)]
